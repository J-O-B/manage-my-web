    ...
    if request.method == "POST":
        ...
        if order_form.is_valid():
            ...
            for item_id, item_data in cart.items():
                try:
                    ...
                    if isinstance(item_data, int):
                        ...
                        for subscription, quantity in (
                            item_data['subscription'].items()):
                            order_line_item = OrderLineItem(
                                order=order,
                                product=product,
                                quantity=quantity,
            ...
            return redirect(reverse(
                'checkout_success', args=[order.order_number, subscription]))
        else:
...
def checkout_success(request, order_number, subscription):
    """
