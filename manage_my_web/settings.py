"""
Django settings for manage_my_web project.
...
ROOT_URLCONF = 'manage_my_web.urls'
...
if "USE_AWS" in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = "manage-my-web"
    ...
    # Override static and media URLs when in production
